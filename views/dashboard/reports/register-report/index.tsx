...
import { useBusinessReportBreadcrumb } from '@/hooks';
...
const RegisterReportView = () => {
    const { items: breadcrumbItems } = useBusinessReportBreadcrumb('Register Report', 'View and analyze your register transactions');
